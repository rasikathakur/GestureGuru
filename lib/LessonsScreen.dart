      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          ...
          onPressed: () {
            ...
            Navigator.pop(context, {'completed': completedCount, 'total': lessonsData!.length - 1});
          },
        ),
        title: isSearching
            ? TextField(
            ...
            onPressed: () {
              setState(() {
                if (isSearching) {
                  ...
                  filteredLessons = lessonsData; // Reset the filter when closing search
                }
                ...
                Checkbox(
                  ...
                  onChanged: (bool? value) {
                    setState(() {
                      ...
                      completedCount = selectedItems.where((item) => item).length;
                    });
                  },
          ...
          child: Container(
            ...
            child: Column(
              children: [
                Expanded(
                  child: InAppWebView(
                    initialUrlRequest: URLRequest(url: Uri.parse(videoLink)),
